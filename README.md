...
[![Cloud: Oracle Cloud ARM](https://img.shields.io/badge/cloud-Oracle%20Cloud%20ARM-red)](./docs/INFRA_AND_SECURITY.md)
...
- **₹0/Month Recurring Infrastructure Cost:** Runs on Oracle Cloud Always Free Tier (ARM Ampere A1, 4 OCPU, 24 GB RAM).
...
```
 ...
 └──────────────┬──────────────┘        └──────────────┬──────────────┘
                ...
                ▼                                      ▼
 ┌────────────────────────────────────────────────────────────────────┐
 │               Oracle Cloud ARM Free Instance                       │
 │                                                                    │
 │   ┌──────────────────┐               ┌─────────────────────────┐   │
...
- [**Tradeoff Analysis & Component Selection (`docs/COMPONENT_SELECTION_TRADEOFFS.md`)**](docs/COMPONENT_SELECTION_TRADEOFFS.md): Exhaustive ADR detailing why every technology was chosen and why alternative options (OpenWeather, GPT-4o, WhatsApp, AWS/GCP) were rejected.
...
- [**Infrastructure & Security Specification (`docs/INFRA_AND_SECURITY.md`)**](docs/INFRA_AND_SECURITY.md): Oracle Cloud ARM specs, zero-inbound Bastion, Terraform, GitHub Actions OIDC pipeline.
...
- **Cloud Provider:** Oracle Cloud Infrastructure (ARM Ampere A1)
- **IaC:** Terraform
