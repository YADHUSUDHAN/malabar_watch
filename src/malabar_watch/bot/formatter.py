...
def format_help_html() -> str:
    """Formats /help command instructions."""
    return (
        "ℹ️ <b>Malabar Watch Bot Help & Commands</b>\n"
        "───────────────────────────\n"
        "<b>Commands Reference:</b>\n"
        "• <code>/status [district]</code> - View live precipitation & risk level.\n"
        "   <i>Example:</i> <code>/status wayanad</code> or <code>/status idukki</code>\n\n"
        "• <code>/subscribe [district]</code> - Register for automated warning pushes.\n"
        "   <i>Example:</i> <code>/subscribe wayanad</code> or <code>/subscribe all</code>\n\n"
        "• <code>/unsubscribe</code> - Stop receiving automatic alert messages.\n\n"
        "• <code>/history [district]</code> - View past rainfall trend and soil saturation.\n"
        "   <i>Example:</i> <code>/history kottayam</code>\n\n"
        "• <code>/disclaimer</code> - Project terms and emergency numbers.\n\n"
        "🌐 <b>Supported Micro-Zones:</b>\n"
        " • <b>Wayanad:</b> Vythiri, Meppadi, Chooralmala\n"
        " • <b>Idukki:</b> Munnar, Devikulam, Pettimudi, Peerumade\n"
        " • <b>Kottayam:</b> Teekoy, Poonjar, Kanjirappally\n"
        "───────────────────────────\n"
        f"{DISCLAIMER_FOOTNOTE}"
    )
