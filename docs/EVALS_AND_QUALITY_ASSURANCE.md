...
|---|---|
| **I. Codebase** | Single git repository tracked in GitHub, deploying to AWS EC2 Free Tier environment. |
...
For production monitoring on AWS EC2 Free Tier (`t2.micro` / `t3.micro`) without adding third-party SaaS costs:
